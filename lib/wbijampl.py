...
mode="wbijampl"
addURL=common.sysaddon+"?mode="+mode
MURL							='https://wbijam.pl'
...
def MainMenu(p):
	xbmcplugin.addDirectoryItem(handle=common.addon_handle,url=addURL+"&action=news",listitem=xbmcgui.ListItem("[COLOR orange]Wiadomości[/COLOR]"),isFolder=True)
	xbmcplugin.addDirectoryItem(handle=common.addon_handle,url=addURL+"&action=lista",listitem=xbmcgui.ListItem("[COLOR orange]Lista[/COLOR]"),isFolder=True)
